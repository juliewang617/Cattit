            ...
            <AppStack.Screen
              ...
              options={{
                tabBarIcon: ({ color, size }) => (
                  <Icon name="house" size={20} color="#F6AFEB" />
                ),
              }}
            />
            <AppStack.Screen
              ...
              options={{
                tabBarIcon: ({ color, size }) => (
                  <Icon name="plus" size={20} color="#F6AFEB" />
                ),
              }}
            />
            <AppStack.Screen
              name="Profile"
              component={ProfileCatsNavigator}
              options={{
                tabBarIcon: ({ color, size }) => (
                  <Icon name="shield-cat" size={20} color="#F6AFEB" />
                ),
              }}
            />
            <AppStack.Screen
              name="Daily Cat Fact"
              component={DailyCatFactScreen}
              options={{
                tabBarIcon: ({ color, size }) => (
                  <Icon name="cat" size={20} color="#F6AFEB" />
                ),
              }}
            />
          </AppStack.Navigator>
